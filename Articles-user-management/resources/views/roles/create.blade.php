                        ...
                        <div id="accordion" class="row">
                            @foreach ($permissionsByGroup as $groupName => $permissions)
                                <div class="card col-12">
                                    ...
                                    <div id="collapse{{ $groupName }}" class="collapse @error('permissions')show @enderror" aria-labelledby="headingOne"
                                        data-parent="#accordion">
                                        <div class="card-body">
                                            @foreach ($permissions as $permission)
                                                <div class="form-check">
                                                    <input name="permissions[]" class="form-check-input" type="checkbox"
                                                        value="{{ $permission->name }}" id="{{ $permission->name }}Check">
